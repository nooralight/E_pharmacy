...
.submenu > li:active {
    ...
    <body>
        ...
        <div class="container">
            <nav class="menu">
                <ul class="main-menu">
                    <li class="active" style="font-size: 13px"><i class="fa fa-home"></i>Update Employee</li>
                </ul>
            </nav>
            <article>
                <form method="post" class="row g-3" style="margin-top: 20px" action="{{url("/emp/update/".$emp->id)}}">
                    @csrf
                    @method("PATCH")
                    ...
                    <div class="col-md-4" >
                      ...
                      <input type="text" class="form-control"  name="idno" value="{{$emp->idno}}" >
                    </div>
