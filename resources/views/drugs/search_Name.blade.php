...
<style>
  body{
    background: url('{{ asset('img/searchN.jpg')}}')center / cover no-repeat;
  	      height: 100vh;
	        margin: 0;
          position: relative;
  }
...
<h3 style="font-size:20px  ">Drug info (Search by Name) </h3>
...
<input type="text" class="form-controller" id="search" name="search" style="padding:11px; font-size:13px" placeholder="Type name.."></input>
