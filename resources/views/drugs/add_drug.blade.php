...
.submenu > li:active {
    ...
    <body>
        <div class="container">
            <nav class="menu">
                <ul class="main-menu">
                    <li class="active"><i class="fa fa-home"></i>Add Drug</li>
                </ul>
            </nav>
            <article>
                <form method="post" class="row g-3" style="margin-top: 20px" action="{{route("addingDrug")}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-2" style="margin-left: 118px">
                      ...
                      <input type="text" class="form-control" id="inputCity" name="mg">
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" id="inputCity" name= "status">
                    </div>
                    <div class="col-md-2">
